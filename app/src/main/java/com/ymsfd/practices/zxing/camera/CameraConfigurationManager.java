...
package com.ymsfd.practices.zxing.camera;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        Log.i(TAG, "Screen resolution1: " + screenResolution);
        /* 竖屏修改 ，图形拉伸处理 */
        ...
        Log.i(TAG, "Screen resolution2: " + screenResolutionForCamera);
    ...
    private Point findBestPreviewSizeValue(Camera.Parameters parameters,
        ...
        for (Camera.Size supportedPreviewSize : supportedPreviewSizes) {
            Log.d(TAG, "Width: " + supportedPreviewSize.width + " Height: "
        ...
        if (camera != null) {
            ...
            if (parameters != null) {
                ...
                return flashMode != null
                        && (Camera.Parameters.FLASH_MODE_ON.equals(flashMode) || Camera
