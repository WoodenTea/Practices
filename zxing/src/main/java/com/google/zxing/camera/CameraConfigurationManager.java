...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(OpenCamera camera) {
        ...
        if (camera.getFacing() == CameraFacing.FRONT) {
            ...
            Log.i(TAG, "Front camera override to: " + cwRotationFromNaturalToCamera);
        }
        ...
        cameraResolution = CameraConfigurationUtils.getOptimalPreviewSize(parameters,
                screenResolution);
        Log.i(TAG, "Camera resolution: " + cameraResolution);
        bestPreviewSize = new Point(cameraResolution);
        Log.i(TAG, "Best available preview size: " + bestPreviewSize);

        Camera.Size size = CameraConfigurationUtils.getOptimalPreviewSize(parameters
                .getSupportedPictureSizes(), screenResolution.y, screenResolution.x);
