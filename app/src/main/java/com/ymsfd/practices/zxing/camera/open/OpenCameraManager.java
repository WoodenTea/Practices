...
package com.ymsfd.practices.zxing.camera.open;

import com.ymsfd.practices.zxing.common.PlatformSupportManager;
...
public final class OpenCameraManager extends PlatformSupportManager<OpenCameraInterface> {
    ...
    public OpenCameraManager() {
        ...
        addImplementationClass(9, "com.google.zxing.client.android.camera.open" +
